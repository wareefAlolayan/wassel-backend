...
this repo contains the backend code of Wassel .backend is responsible for manging and storing data for teams , employees , shifts , and vacation requests , it also hamdelss authentication using jwt 
...
| **POST**   | `/login/`                                            | `TokenObtainPairView`           | Obtain JWT token (login)                             |
